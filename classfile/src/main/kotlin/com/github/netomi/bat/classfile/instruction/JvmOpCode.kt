...
enum class JvmOpCode constructor(
    ...
    ANEWARRAY      (0xbd, "anewarray",   3, { ClassInstruction.create(it) }),
    ...
    LDC            (0x12, "ldc",    2, { ConstantInstruction.create(it) }),
    LDC_W          (0x13, "ldc_w",  3, { ConstantInstruction.create(it) }),
    LDC2_W         (0x14, "ldc2_w", 3, { ConstantInstruction.create(it) }),
    ...
    NEWARRAY       (0xbc, "newarray",    2, { ArrayTypeInstruction.create(it) }),
