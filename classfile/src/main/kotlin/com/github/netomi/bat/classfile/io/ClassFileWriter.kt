...
class ClassFileWriter constructor(private val outputStream: OutputStream): ClassFileVisitor {

    private val dataOutput: ClassDataOutput = ClassDataOutput.of(outputStream)
