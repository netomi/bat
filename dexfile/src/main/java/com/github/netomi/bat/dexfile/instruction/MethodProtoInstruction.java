...
public class MethodProtoInstruction
extends      MethodInstruction
{
    private int protoIndex;

    static MethodProtoInstruction create(DexOpCode opCode, byte ident) {
        return new MethodProtoInstruction(opCode);
    }

    MethodProtoInstruction(DexOpCode opcode) {
        super(opcode);
