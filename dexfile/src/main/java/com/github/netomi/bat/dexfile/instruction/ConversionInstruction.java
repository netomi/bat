...
{
    static ConversionInstruction create(DexOpCode opCode, byte ident) {
        return new ConversionInstruction(opCode);
    }

    ConversionInstruction(DexOpCode opcode) {
        super(opcode);
    }
    ...
    public void read(short[] instructions, int offset) {
        ...
        if (opcode.getFormat() != FORMAT_12x) {
