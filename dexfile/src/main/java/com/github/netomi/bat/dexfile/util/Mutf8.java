...
public final class Mutf8
{
     ...
     */
    public static String decode(byte[] in, int utf16len) throws RuntimeException {
        ...
        while (true) {
            ...
            if (a < '\u0080') {
                ...
                int b = in[i++] & 0xff;
                if ((b & 0xC0) != 0x80) {
                    throw new RuntimeException(new UTFDataFormatException("bad second byte"));
                }
                ...
                if (((b & 0xC0) != 0x80) || ((c & 0xC0) != 0x80)) {
                    throw new RuntimeException(new UTFDataFormatException("bad second or third byte"));
                }
                out[s++] = (char) (((a & 0x0F) << 12) | ((b & 0x3F) << 6) | (c & 0x3F));
            } else {
                throw new RuntimeException(new UTFDataFormatException("bad byte"));
            }
        }
    }
