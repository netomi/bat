...
public enum DexOpCode
{
    ...
    ADD_INT_LIT16((byte) 0xd0, FORMAT_22s, ArithmeticInstruction::create, "add-int/lit16"),
    RSUB_INT(     (byte) 0xd1, FORMAT_22s, ArithmeticInstruction::create, "rsub-int"),
    MUL_INT_LIT16((byte) 0xd2, FORMAT_22s, ArithmeticInstruction::create, "mul-int/lit16"),
    DIV_INT_LIT16((byte) 0xd3, FORMAT_22s, ArithmeticInstruction::create, "div-int/lit16"),
    REM_INT_LIT16((byte) 0xd4, FORMAT_22s, ArithmeticInstruction::create, "rem-int/lit16"),
    AND_INT_LIT16((byte) 0xd5, FORMAT_22s, ArithmeticInstruction::create, "and-int/lit16"),
    OR_INT_LIT16( (byte) 0xd6, FORMAT_22s, ArithmeticInstruction::create, "or-int/lit16"),
    XOR_INT_LIT16((byte) 0xd7, FORMAT_22s, ArithmeticInstruction::create, "xor-int/lit16"),

    ADD_INT_LIT8( (byte) 0xd8, FORMAT_22b, ArithmeticInstruction::create, "add-int/lit8"),
    RSUB_INT_LIT8((byte) 0xd9, FORMAT_22b, ArithmeticInstruction::create, "rsub-int/lit8"),
    MUL_INT_LIT8( (byte) 0xda, FORMAT_22b, ArithmeticInstruction::create, "mul-int/lit8"),
    DIV_INT_LIT8( (byte) 0xdb, FORMAT_22b, ArithmeticInstruction::create, "div-int/lit8"),
    REM_INT_LIT8( (byte) 0xdc, FORMAT_22b, ArithmeticInstruction::create, "rem-int/lit8"),
    AND_INT_LIT8( (byte) 0xdd, FORMAT_22b, ArithmeticInstruction::create, "and-int/lit8"),
    OR_INT_LIT8(  (byte) 0xde, FORMAT_22b, ArithmeticInstruction::create, "or-int/lit8"),
    XOR_INT_LIT8( (byte) 0xdf, FORMAT_22b, ArithmeticInstruction::create, "xor-int/lit8"),
    SHL_INT_LIT8( (byte) 0xe0, FORMAT_22b, ArithmeticInstruction::create, "shl-int/lit8"),
    SHR_INT_LIT8( (byte) 0xe1, FORMAT_22b, ArithmeticInstruction::create, "shr-int/lit8"),
    USHR_INT_LIT8((byte) 0xe2, FORMAT_22b, ArithmeticInstruction::create, "ushr-int/lit8"),

    INVOKE_POLYMORPHIC((byte) 0xfa, FORMAT_45cc, "invoke-polymorphic"),
    INVOKE_POLYMORPHIC_RANGE((byte) 0xfb, FORMAT_4rcc, "invoke-polymorphic/range"),
