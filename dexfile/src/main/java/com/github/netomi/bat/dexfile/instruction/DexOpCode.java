...
public enum DexOpCode
{
    ...
    IF_EQ( (byte) 0x32, DexInstructionFormat.FORMAT_22t, BranchInstruction::create, "if-eq"),
    IF_NE( (byte) 0x33, DexInstructionFormat.FORMAT_22t, BranchInstruction::create, "if-ne"),
    IF_LT( (byte) 0x34, DexInstructionFormat.FORMAT_22t, BranchInstruction::create, "if-lt"),
    IF_GE( (byte) 0x35, DexInstructionFormat.FORMAT_22t, BranchInstruction::create, "if-ge"),
    IF_GT( (byte) 0x36, DexInstructionFormat.FORMAT_22t, BranchInstruction::create, "if-gt"),
    IF_LE( (byte) 0x37, DexInstructionFormat.FORMAT_22t, BranchInstruction::create, "if-le"),
    IF_EQZ((byte) 0x38, DexInstructionFormat.FORMAT_21t, BranchInstruction::create, "if-eqz"),
    IF_NEZ((byte) 0x39, DexInstructionFormat.FORMAT_21t, BranchInstruction::create, "if-nez"),
    IF_LTZ((byte) 0x3a, DexInstructionFormat.FORMAT_21t, BranchInstruction::create, "if-ltz"),
    IF_GEZ((byte) 0x3b, DexInstructionFormat.FORMAT_21t, BranchInstruction::create, "if-gez"),
    IF_GTZ((byte) 0x3c, DexInstructionFormat.FORMAT_21t, BranchInstruction::create, "if-gtz"),
    IF_LEZ((byte) 0x3d, DexInstructionFormat.FORMAT_21t, BranchInstruction::create, "if-lez"),
    ...
    INT_TO_SHORT(   (byte) 0x8f, DexInstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "int-to-short"),

    ADD_INT(   (byte) 0x90, DexInstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "add-int"),
    SUB_INT(   (byte) 0x91, DexInstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "sub-int"),
    MUL_INT(   (byte) 0x92, DexInstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "mul-int"),
    DIV_INT(   (byte) 0x93, DexInstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "div-int"),
    REM_INT(   (byte) 0x94, DexInstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "rem-int"),
    AND_INT(   (byte) 0x95, DexInstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "and-int"),
    OR_INT(    (byte) 0x96, DexInstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "or-int"),
    XOR_INT(   (byte) 0x97, DexInstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "xor-int"),
    ...
    MUL_INT_2ADDR(   (byte) 0xb2, DexInstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "mul-int/2addr"),
    DIV_INT_2ADDR(   (byte) 0xb3, DexInstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "div-int/2addr"),
    REM_INT_2ADDR(   (byte) 0xb4, DexInstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "rem-int/2addr"),
    AND_INT_2ADDR(   (byte) 0xb5, DexInstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "and-int/2addr"),
    OR_INT_2ADDR(    (byte) 0xb6, DexInstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "or-int/2addr"),
    XOR_INT_2ADDR(   (byte) 0xb7, DexInstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "xor-int/2addr"),
