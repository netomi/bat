...
enum class DexOpCode constructor(
    ...
    MOVE_WIDE         (0x04, InstructionFormat.FORMAT_12x, BasicInstruction::create, "move-wide", true),
    MOVE_WIDE_FROM16  (0x05, InstructionFormat.FORMAT_22x, BasicInstruction::create, "move-wide/from16", true),
    MOVE_WIDE_16      (0x06, InstructionFormat.FORMAT_32x, BasicInstruction::create, "move-wide/16", true),
    ...
    MOVE_RESULT_WIDE  (0x0b, InstructionFormat.FORMAT_11x, BasicInstruction::create, "move-result-wide", true),
    ...
    RETURN_WIDE       (0x10, InstructionFormat.FORMAT_11x, BasicInstruction::create, "return-wide", true),
    ...
    CONST_WIDE_16    (0x16, InstructionFormat.FORMAT_21s, LiteralInstruction::create, "const-wide/16", true),
    CONST_WIDE_32    (0x17, InstructionFormat.FORMAT_31i, LiteralInstruction::create, "const-wide/32", true),
    CONST_WIDE       (0x18, InstructionFormat.FORMAT_51l, LiteralInstruction::create, "const-wide", true),
    CONST_WIDE_HIGH16(0x19, InstructionFormat.FORMAT_21h, LiteralInstruction::create, "const-wide/high16", true),
    ...
    CMPL_DOUBLE(0x2f, InstructionFormat.FORMAT_23x, BasicInstruction::create, "cmpl-double", true),
    CMPG_DOUBLE(0x30, InstructionFormat.FORMAT_23x, BasicInstruction::create, "cmpg-double", true),
    CMP_LONG   (0x31, InstructionFormat.FORMAT_23x, BasicInstruction::create, "cmp-long", true),
    ...
    AGET_WIDE   (0x45, InstructionFormat.FORMAT_23x, ArrayInstruction::create, "aget-wide", true),
    ...
    APUT_WIDE   (0x4c, InstructionFormat.FORMAT_23x, ArrayInstruction::create, "aput-wide", true),
    ...
    IGET_WIDE   (0x53, InstructionFormat.FORMAT_22c, FieldInstruction::create, "iget-wide", true),
    ...
    IPUT_WIDE   (0x5a, InstructionFormat.FORMAT_22c, FieldInstruction::create, "iput-wide", true),
    ...
    SGET_WIDE   (0x61, InstructionFormat.FORMAT_21c, FieldInstruction::create, "sget-wide", true),
    ...
    SPUT_WIDE   (0x68, InstructionFormat.FORMAT_21c, FieldInstruction::create, "sput-wide", true),
    ...
    NEG_LONG  (0x7d, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "neg-long", true),
    NOT_LONG  (0x7e, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "not-long", true),
    NEG_FLOAT (0x7f, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "neg-float"),
    NEG_DOUBLE(0x80, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "neg-double", true),

    // conversion instructions.
    INT_TO_LONG    (0x81, InstructionFormat.FORMAT_12x, ConversionInstruction::create, "int-to-long", true),
    INT_TO_FLOAT   (0x82, InstructionFormat.FORMAT_12x, ConversionInstruction::create, "int-to-float"),
    INT_TO_DOUBLE  (0x83, InstructionFormat.FORMAT_12x, ConversionInstruction::create, "int-to-double", true),
    LONG_TO_INT    (0x84, InstructionFormat.FORMAT_12x, ConversionInstruction::create, "long-to-int", true),
    LONG_TO_FLOAT  (0x85, InstructionFormat.FORMAT_12x, ConversionInstruction::create, "long-to-float", true),
    LONG_TO_DOUBLE (0x86, InstructionFormat.FORMAT_12x, ConversionInstruction::create, "long-to-double", true),
    FLOAT_TO_INT   (0x87, InstructionFormat.FORMAT_12x, ConversionInstruction::create, "float-to-int"),
    FLOAT_TO_LONG  (0x88, InstructionFormat.FORMAT_12x, ConversionInstruction::create, "float-to-long", true),
    FLOAT_TO_DOUBLE(0x89, InstructionFormat.FORMAT_12x, ConversionInstruction::create, "float-to-double", true),
    DOUBLE_TO_INT  (0x8a, InstructionFormat.FORMAT_12x, ConversionInstruction::create, "double-to-int", true),
    DOUBLE_TO_LONG (0x8b, InstructionFormat.FORMAT_12x, ConversionInstruction::create, "double-to-long", true),
    DOUBLE_TO_FLOAT(0x8c, InstructionFormat.FORMAT_12x, ConversionInstruction::create, "double-to-float", true),
    ...
    ADD_LONG        (0x9b, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "add-long", true),
    SUB_LONG        (0x9c, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "sub-long", true),
    MUL_LONG        (0x9d, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "mul-long", true),
    DIV_LONG        (0x9e, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "div-long", true),
    REM_LONG        (0x9f, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "rem-long", true),
    AND_LONG        (0xa0, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "and-long", true),
    OR_LONG         (0xa1, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "or-long", true),
    XOR_LONG        (0xa2, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "xor-long", true),
    SHL_LONG        (0xa3, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "shl-long", true),
    SHR_LONG        (0xa4, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "shr-long", true),
    USHR_LONG       (0xa5, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "ushr-long", true),
    ...
    ADD_DOUBLE      (0xab, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "add-double", true),
    SUB_DOUBLE      (0xac, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "sub-double", true),
    MUL_DOUBLE      (0xad, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "mul-double", true),
    DIV_DOUBLE      (0xae, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "div-double", true),
    REM_DOUBLE      (0xaf, InstructionFormat.FORMAT_23x, ArithmeticInstruction::create, "rem-double", true),
    ...
    ADD_LONG_2ADDR  (0xbb, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "add-long/2addr", true),
    SUB_LONG_2ADDR  (0xbc, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "sub-long/2addr", true),
    MUL_LONG_2ADDR  (0xbd, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "mul-long/2addr", true),
    DIV_LONG_2ADDR  (0xbe, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "div-long/2addr", true),
    REM_LONG_2ADDR  (0xbf, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "rem-long/2addr", true),
    AND_LONG_2ADDR  (0xc0, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "and-long/2addr", true),
    OR_LONG_2ADDR   (0xc1, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "or-long/2addr", true),
    XOR_LONG_2ADDR  (0xc2, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "xor-long/2addr", true),
    SHL_LONG_2ADDR  (0xc3, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "shl-long/2addr", true),
    SHR_LONG_2ADDR  (0xc4, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "shr-long/2addr", true),
    USHR_LONG_2ADDR (0xc5, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "ushr-long/2addr", true),
    ...
    ADD_DOUBLE_2ADDR(0xcb, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "add-double/2addr", true),
    SUB_DOUBLE_2ADDR(0xcc, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "sub-double/2addr", true),
    MUL_DOUBLE_2ADDR(0xcd, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "mul-double/2addr", true),
    DIV_DOUBLE_2ADDR(0xce, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "div-double/2addr", true),
    REM_DOUBLE_2ADDR(0xcf, InstructionFormat.FORMAT_12x, ArithmeticInstruction::create, "rem-double/2addr", true),
    ...
    INVOKE_POLYMORPHIC      (0xfa, InstructionFormat.FORMAT_45cc, MethodProtoInstruction::create, "invoke-polymorphic"),
    INVOKE_POLYMORPHIC_RANGE(0xfb, InstructionFormat.FORMAT_4rcc, MethodProtoInstruction::create, "invoke-polymorphic/range"),

    // callsite instructions.
    INVOKE_CUSTOM      (0xfc, InstructionFormat.FORMAT_35c, CallSiteInstruction::create, "invoke-custom"),
    INVOKE_CUSTOM_RANGE(0xfd, InstructionFormat.FORMAT_3rc, CallSiteInstruction::create, "invoke-custom/range"),

    // method handle and proto instructions.
    CONST_METHOD_HANDLE(0xfe, InstructionFormat.FORMAT_21c, MethodHandleRefInstruction::create, "const-method-handle"),
    CONST_METHOD_TYPE  (0xff, InstructionFormat.FORMAT_21c, MethodTypeRefInstruction::create, "const-method-type");
