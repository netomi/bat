...
public interface InstructionVisitor
{
    ...
    static InstructionVisitor concatenate(InstructionVisitor... visitors) {
        return new InstructionVisitor() {
            ...
            public void visitAnyInstruction(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, DexInstruction instruction) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitAnyInstruction(dexFile, classDef, method, code, offset, instruction);
                }
            }
            ...
            public void visitArithmeticInstruction(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, ArithmeticInstruction instruction) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitArithmeticInstruction(dexFile, classDef, method, code, offset, instruction);
                }
            }

            @Override
            public void visitArrayInstruction(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, ArrayInstruction instruction) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitArrayInstruction(dexFile, classDef, method, code, offset, instruction);
                }
            }

            @Override
            public void visitBasicInstruction(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, BasicInstruction instruction) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitBasicInstruction(dexFile, classDef, method, code, offset, instruction);
                }
            }
            ...
            public void visitBranchInstruction(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, BranchInstruction instruction) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitBranchInstruction(dexFile, classDef, method, code, offset, instruction);
                }
            }

            @Override
            public void visitConversionInstruction(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, ConversionInstruction instruction) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitConversionInstruction(dexFile, classDef, method, code, offset, instruction);
                }
            }
            ...
            public void visitFieldInstruction(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, FieldInstruction instruction) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitFieldInstruction(dexFile, classDef, method, code, offset, instruction);
                }
            }
            ...
            public void visitLiteralInstruction(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, LiteralInstruction instruction) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitLiteralInstruction(dexFile, classDef, method, code, offset, instruction);
                }
            }
            ...
            public void visitMethodInstruction(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, MethodInstruction instruction) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitMethodInstruction(dexFile, classDef, method, code, offset, instruction);
                }
            }
            ...
            public void visitPayloadInstruction(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, PayloadInstruction instruction) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitPayloadInstruction(dexFile, classDef, method, code, offset, instruction);
                }
            }
            ...
            public void visitStringInstruction(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, StringInstruction instruction) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitStringInstruction(dexFile, classDef, method, code, offset, instruction);
                }
            }
            ...
            public void visitTypeInstruction(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, TypeInstruction instruction) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitTypeInstruction(dexFile, classDef, method, code, offset, instruction);
                }
            }

            @Override
            public void visitAnyPayload(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, Payload payload) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitAnyPayload(dexFile, classDef, method, code, offset, payload);
                }
            }
            ...
            public void visitFillArrayPayload(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, FillArrayPayload payload) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitFillArrayPayload(dexFile, classDef, method, code, offset, payload);
                }
            }
            ...
            public void visitPackedSwitchPayload(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, PackedSwitchPayload payload) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitPackedSwitchPayload(dexFile, classDef, method, code, offset, payload);
                }
            }
            ...
            public void visitSparseSwitchPayload(DexFile dexFile, ClassDef classDef, EncodedMethod method, Code code, int offset, SparseSwitchPayload payload) {
                for (InstructionVisitor visitor : visitors) {
                    visitor.visitSparseSwitchPayload(dexFile, classDef, method, code, offset, payload);
                }
            }
        };
    }
